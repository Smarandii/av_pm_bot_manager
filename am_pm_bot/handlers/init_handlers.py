...
async def on_startup(bot: Bot) -> None:
    ...
    """
    await bot.send_message(chat_id=1338865950, text='Bot has been started ' + f"{WEBHOOK_HOST}{WEBHOOK_PATH}")
...
async def on_shutdown(bot: Bot) -> None:
    ...
    """
    await bot.send_message(chat_id=1338865950, text='Bot has been stopped')
